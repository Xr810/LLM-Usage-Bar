> **已归档 —— 不要据此判断现状。**
> 本文是 2026-08-13 的初版草案,其中若干判断已被 2026-08-14 的实测推翻(最重要的一条:
> 「官方登录 + 用自己的 provider」纯配置就能做到,不需要 router)。
> **现行设计见 [`../design/2026-08-14-local-routing-design.md`](../design/2026-08-14-local-routing-design.md)。**
> 保留本文只为追溯「当初怎么想的」。
