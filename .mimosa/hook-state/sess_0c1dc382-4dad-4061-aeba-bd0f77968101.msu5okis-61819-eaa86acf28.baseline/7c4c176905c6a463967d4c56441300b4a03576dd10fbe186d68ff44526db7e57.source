...
pub const RELEASES_LATEST_URL: &str = "https://github.com/Xr810/LLM-Usage-Bar/releases/latest";
pub const MANAGED_UPDATES_UNAVAILABLE: &str = "managed_updates_unavailable";
...
/// Existing remote sync trees must remain readable and writable in place.
pub const LEGACY_SYNC_REMOTE_ROOT: &str = "cc-switch-sync";
pub const LEGACY_SYNC_PROTOCOL_FORMAT: &str = "cc-switch-webdav-sync";
/// OpenAI's Codex backend compatibility headers are retained byte-for-byte.
pub const LEGACY_CODEX_OAUTH_ORIGINATOR: &str = "cc-switch";
pub const LEGACY_CODEX_OAUTH_USER_AGENT: &str = "cc-switch-codex-oauth";
...
mod tests {
    ...
    fn current_and_legacy_identity_are_explicitly_separate() {
        ...
        assert_eq!(MANAGED_UPDATES_UNAVAILABLE, "managed_updates_unavailable");
        ...
        assert_eq!(LEGACY_SYNC_REMOTE_ROOT, "cc-switch-sync");
        assert_eq!(LEGACY_SYNC_PROTOCOL_FORMAT, "cc-switch-webdav-sync");
        assert_eq!(LEGACY_CODEX_OAUTH_ORIGINATOR, "cc-switch");
        assert_eq!(LEGACY_CODEX_OAUTH_USER_AGENT, "cc-switch-codex-oauth");
