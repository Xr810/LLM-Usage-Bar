...
const requiredKeys = [
  ...
  "usageDashboard.paceWhyThisColour",
  "usageDashboard.paceBurnRate",
  "usageDashboard.paceIdle",
  "usageDashboard.pacePercentPerHour",
  "usageDashboard.paceRunsOut",
  "usageDashboard.paceAfterReset",
  "usageDashboard.paceNotAtThisRate",
  "usageDashboard.paceRhythm",
  "usageDashboard.paceRhythmQuieter",
  "usageDashboard.paceRhythmBusier",
  "usageDashboard.paceBasis",
  "usageDashboard.paceBasisMeasured",
  "usageDashboard.paceBasisWindowAverage",
  ...
  "settings.usagePaceGreen",
  "settings.usagePaceGreenBody",
  "settings.usagePaceYellow",
  "settings.usagePaceYellowBody",
  "settings.usagePaceRed",
  "settings.usagePaceRedBody",
  "settings.usagePaceExhaustedNote",
  "settings.usagePaceNoResetNote",
  "trayUsage.updated",
  ...
  "trayUsage.rhythmQuieter",
  "trayUsage.rhythmBusier",
  "trayUsage.today",
  "trayUsage.ofBudget",
