...
export function RequestLogTable({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border bg-card/50 p-2 backdrop-blur-xs">
      ...
      {isLoading ? (
        ...
        <>
          <div className="rounded-lg border border-border/50 bg-card/40 backdrop-blur-xs overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
